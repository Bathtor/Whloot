...
["", "test.dart", , V, {
  ...
  onDataLoaded: [function(responseText) {
    P.print(responseText);
  }, "call$1", "onDataLoaded$closure", 2, 0, 5],
  main: [function() {
    W.HttpRequest_getString("http://127.0.0.1:8012/corstest", null, null).then$1(V.onDataLoaded$closure());
